...
public class KissesQskill : MonoBehaviourPunCallbacks
{
    public PhotonView PV;
    public float QDamage = 20.0f;
    ...
    private void OnTriggerEnter(Collider col)
    {
        if (PV.IsMine && col.CompareTag("EnemyHero") || PV.IsMine && col.CompareTag("EnemyMinion"))
        {
            ...
            PV.RPC("HitFunc", RpcTarget.All, targetId, QDamage+GameObject.FindGameObjectWithTag("Player").GetComponent<Status>().AP);
